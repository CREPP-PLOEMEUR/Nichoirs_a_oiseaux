...
void setup()
{
    ...
    const char* SSID_L = "xxxxxxxxxxx"; // Nom du réseau Wi-Fi
    const char* MOT_DE_PASSE_L = "xxxxxxxxxxxxx"; // Mot De Passe du réseau

      //const char* SSID_L = "creafab_invite"; // Nom du réseau Wi-Fi CREPP
      //const char* MOT_DE_PASSE_L = "MonTraficEstJournalise"; // Mot De Passe du réseau CREPP
...
{
    const char* ADRESSE_EMAIL_EMISSION_L = "mon_emailg@gmail.com";
    const char* MOT_DE_PASSE_APPLICATION_L = "xxxxxxxxxxxxxxxx";
    const char* ADRESSE_SERVEUR_SMTP_L = "smtp.gmail.com";
    int PORT_SERVEUR_SMTP_L = 465; // Port SSL utilisé
    const char* ADRESSE_EMAIL_DESTINATAIRE_L = "mon_email@gmail.com";
...
esp_err_t InitialiserCamera()
{
    ...
    ConfigurationCamera_L.frame_size = FRAMESIZE_VGA;
